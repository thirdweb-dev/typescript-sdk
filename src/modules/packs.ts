...
import { PacksModuleSchema } from "../schema/modules/packs";
...
export class PacksModule implements UpdateableNetwork {
  ...
  public metadata: ContractMetadata<Pack, typeof PacksModule.schema>;
  public roles: ContractRoles<Pack, typeof PacksModule.moduleRoles[number]>;
  public encoder: ContractEncoder<Pack>;
  public royalty: ContractRoyalty<Pack, typeof PacksModule.schema>;
  ...
  constructor(
    ...
    storage: IStorage,
    options: SDKOptions = {},
    contractWrapper = new ContractWrapper<Pack>(
      network,
      address,
      PacksModule.contractFactory.abi,
      options,
    ),
  ) {
