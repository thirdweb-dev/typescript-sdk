...
import { MarketplaceModuleSchema } from "../schema/modules/marketplace";
import {
  AuctionListing,
  DirectListing,
  NewAuctionListing,
...
export class MarketplaceModule implements UpdateableNetwork {
  ...
  public metadata: ContractMetadata<
    Marketplace,
    typeof MarketplaceModule.schema
  >;
  public roles: ContractRoles<
    Marketplace,
    typeof MarketplaceModule.moduleRoles[number]
  >;
  ...
  constructor(
    ...
    contractWrapper = new ContractWrapper<Marketplace>(
      network,
      address,
      MarketplaceModule.contractFactory.abi,
      options,
    ),
  ) {
    ...
    this.metadata = new ContractMetadata(
      ...
      MarketplaceModule.schema,
      this.storage,
    );
    this.roles = new ContractRoles(
      this.contractWrapper,
      MarketplaceModule.moduleRoles,
    );
