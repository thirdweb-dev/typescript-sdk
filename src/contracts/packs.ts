...
export class PacksContract implements UpdateableNetwork {
  ...
  public metadata: ContractMetadata<Pack, typeof PacksContract.schema>;
  public roles: ContractRoles<Pack, typeof PacksContract.contractRoles[number]>;
  public encoder: ContractEncoder<Pack>;
  public royalty: ContractRoyalty<Pack, typeof PacksContract.schema>;
  ...
  constructor(
    ...
    contractWrapper = new ContractWrapper<Pack>(
      network,
      address,
      PacksContract.contractFactory.abi,
      options,
    ),
  ) {
    ...
    this.metadata = new ContractMetadata(
      ...
      PacksContract.schema,
      this.storage,
    );
    this.roles = new ContractRoles(
      this.contractWrapper,
      PacksContract.contractRoles,
    );
