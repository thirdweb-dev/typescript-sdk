import { ThirdwebFactory, ThirdwebFactory__factory } from "@3rdweb/contracts";
import { SDKOptions } from "../../schema/sdk-options";
import { TW_FACTORY_ADDRESS } from "../../constants/addresses";
import { ModuleType, NetworkOrSignerOrProvider } from "../types";
import { ContractWrapper } from "./contract-wrapper";

export class ModuleFactory extends ContractWrapper<ThirdwebFactory> {
  constructor(network: NetworkOrSignerOrProvider, options?: SDKOptions) {
    super(network, options, TW_FACTORY_ADDRESS, ThirdwebFactory__factory.abi);
  }
