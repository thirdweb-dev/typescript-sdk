  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct IByocRegistry.CustomContractInstance",
...
export class IByocRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IByocRegistryInterface {
    return new utils.Interface(_abi) as IByocRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IByocRegistry {
    return new Contract(address, _abi, signerOrProvider) as IByocRegistry;
  }
}
