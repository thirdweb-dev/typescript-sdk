...
export interface IThirdwebPrimarySaleInterface extends utils.Interface {
  functions: {
...
export interface IThirdwebPrimarySale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IThirdwebPrimarySaleInterface;
