...
export interface SignatureMintUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface SignatureMintUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SignatureMintUpgradeableInterface;
