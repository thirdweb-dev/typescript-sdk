...
export interface IThirdwebRoyaltyInterface extends utils.Interface {
  functions: {
...
export interface IThirdwebRoyalty extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IThirdwebRoyaltyInterface;
