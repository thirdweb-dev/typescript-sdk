...
```typescript
export declare class ModuleWithRoles<TContract extends BaseContract> extends Module<TContract> 
```
...
|  [onlyRoles(roles, address)](./sdk.modulewithroles.onlyroles.md) |  | Throws an error if an address is missing the roles specified. |
