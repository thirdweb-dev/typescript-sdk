...
|  --- | --- | --- |
|  [(constructor)(connection, address, storage, options, contractWrapper)](./sdk.editiondrop._constructor_.md) |  | Constructs a new instance of the <code>EditionDrop</code> class |
