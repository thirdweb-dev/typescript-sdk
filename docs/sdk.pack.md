...
|  --- | --- | --- |
|  [(constructor)(network, address, storage, chainOrRpc, options, contractWrapper)](./sdk.pack._constructor_.md) |  | Constructs a new instance of the <code>Pack</code> class |
