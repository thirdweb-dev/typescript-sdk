...
|  --- | --- | --- |
|  [(constructor)(connection, address, storage, options, contractWrapper)](./sdk.nftcollection._constructor_.md) |  | Constructs a new instance of the <code>NFTCollection</code> class |
