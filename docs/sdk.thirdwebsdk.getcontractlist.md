...
getContractList(walletAddress: string): Promise<{
        address: string;
        contractType: "split" | "nft-stack-drop" | "nft-stack-collection" | "token" | "vote" | "marketplace" | "pack" | "nft-drop" | "nft-collection";
        metadata: () => Promise<{
            [x: string]: Json;
