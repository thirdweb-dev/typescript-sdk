...
[Home](./index.md) &gt; [@3rdweb/sdk](./sdk.md) &gt; [ProposalExecutable](./sdk.proposalexecutable.md)
...
|  --- | --- | --- |
|  [nativeTokenValue](./sdk.proposalexecutable.nativetokenvalue.md) | BigNumber | The amount of a native token that may be sent if a proposal is executing a token transfer. |
