...
```typescript
export declare class Erc1155<T extends DropERC1155 | TokenERC1155 | BaseSignatureMintERC1155 | BaseERC1155 = BaseERC1155> implements UpdateableNetwork, DetectableFeature 
```
