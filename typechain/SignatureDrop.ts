...
export interface SignatureDropInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, IDropSinglePhase.AllowlistProofStruct]
  ): string;
...
export type TokenLazyMintedEvent = TypedEvent<
  [BigNumber, BigNumber, string, string],
  TokenLazyMintedEventObject
>;

export type TokenLazyMintedEventFilter = TypedEventFilter<TokenLazyMintedEvent>;
...
export type TokensMintedWithSignatureEvent = TypedEvent<
  [string, string, ISignatureMintERC721.MintRequestStructOutput],
...
export interface SignatureDrop extends BaseContract {
  ...
  filters: {
    ...
    "TokenLazyMinted(uint256,uint256,string,bytes)"(
      startId?: BigNumberish | null,
      amount?: null,
      baseURI?: string | null,
      encryptedBaseURI?: null
    ): TokenLazyMintedEventFilter;
    TokenLazyMinted(
      startId?: BigNumberish | null,
      amount?: null,
      baseURI?: string | null,
    ...
    "TokensClaimed(tuple,address,address,uint256,uint256)"(
      condition?: null,
      claimer?: string | null,
      receiver?: string | null,
      quantityClaimed?: null,
      aux?: BigNumberish | null
    ...
    "TokensMinted(address,address,uint256,uint256,uint256,address)"(
      minter?: string | null,
      receiver?: null,
